...
for i in range(n_analog_signals):
    ...
    an+=[["Analog index:" + str(i) + " Channel Name: " + anname, "Lenght: "+ anlenght, " Unit: " + anunit, " Sampling Rate: " + ansampling_rate, " Duration: " + antime]]
...
for i in range(n_analog_signals, n_spike_trains + n_analog_signals):
    ...
    spk+=[["SpikeTrain index:" + str(i-n_analog_signals)) + " Channel Id: " + spkid, " " + spkcreated, " Name: " + spkname, " Size: "+ spksize, " Unit: " + spkunit]]
